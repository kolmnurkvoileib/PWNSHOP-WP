...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230301_4d4dfdec599f51dc9990_20230301112440_archive.zip';
        const ARCHIVE_SIZE       = '1317241443';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '4d4dfde-01112440';
        const SECONDARY_PACKAGE_HASH = '5388ed5-01112440';
